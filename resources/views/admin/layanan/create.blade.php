                    ...
                    <form action="{{ route('admin.layanan.store') }}" method="POST">
                        ...
                        <table class="w-full text-gray-800">
                            ...
                            <tr class="border-b">
                                ...
                                <td><input type="text" name="icon" class="w-full border-gray-300 rounded-lg p-2"
                                        placeholder="contoh: fas fa-info-circle" required></td>
                            </tr>

                            <tr class="border-b">
                                <th class="text-left py-3">Warna Latar</th>
                                <td><input type="color" name="warna" class="w-16 h-10 p-1 border rounded-lg"></td>
                            </tr>

                            <tr class="border-b">
                                <th class="text-left py-3">Link</th>
                                <td><input type="text" name="link" class="w-full border-gray-300 rounded-lg p-2"
                                        placeholder="contoh: /layanan-publik"></td>
                            </tr>
                        </table>
